...
export default class Correct extends BaseEntity{
	...
	async doSearch(){
		...
		const response = await HTTPClient._get(`${this.endpoint}/correct/A0D7D114-7404-47F2-99F9-7809E7228959`, this.search, config);
